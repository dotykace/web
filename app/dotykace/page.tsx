...
export default function DotykacePage() {
  ...
  const finishSubheader = "Dokončili jste interaktivní zkušenost s mobilem.\nDěkujeme!"
  ...
  return <DefaultWaitingScreen subheader={finished ? finishSubheader : undefined} header={finished ? finishHeader : undefined} />;
}